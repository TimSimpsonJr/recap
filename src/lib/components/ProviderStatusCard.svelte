...
>
  <div style="display:flex;align-items:center;gap:10px;">
    <span style="font-family:'DM Sans',sans-serif;font-size:14px;font-weight:500;color:#D8D5CE;">
      {label}
    </span>
  </div>
  ...
  <div style="display:flex;align-items:center;gap:12px;">
    <div style="display:flex;align-items:center;gap:6px;">
      {#if isConnected}
        ...
        <span style="font-size:12.5px;color:#B0ADA5;">
          Connected{providerState.displayName ? ` as ${providerState.displayName}` : ""}
        </span>
      {:else if needsReconnect}
        <span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:#f59e0b;"></span>
        <span style="font-size:12.5px;color:#f59e0b;">Reconnect required</span>
      {:else}
        <span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:#585650;"></span>
        <span style="font-size:12.5px;color:#78756E;">Not connected</span>
      {/if}
    </div>

    <button
      onclick={onconfigure}
      style="font-family:'DM Sans',sans-serif;font-size:12.5px;color:#A8A078;background:none;border:1px solid #A8A078;border-radius:6px;padding:4px 12px;cursor:pointer;"
